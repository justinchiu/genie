...
class CrnnLmCa(LvmA):
    ...
    def pa0(self, emb_x, s, x_info, emb_e, ue_info, emb_t, ut_info, v2dx):
        ...
        if not self.inputfeed:
            ...
            for t in range(T):
                ...
                out.append(ntorch.cat([rnn_o, vc_t, ec_t, tc_t], "rnns"))
    ...
    def log_pc(self, rnn_o, ec, tc, vc):
        ...
        # rW_a = g(r, a) = r[a]
        return self.Wcopy(ntorch.cat([rnn_o, ec, tc, vc], "rnns")).log_softmax("copy")
    ...
    def log_qac_y(self, emb_y, y_info, emb_e, ue_info, emb_t, ut_info, v2dx):
        ...
        log_c = self.Wicopy(rnn_o).log_softmax("copy")
        ...
        if learn:
            ...
            backward(
                [
                    #rnn_o.values,
                    log_py_Ea.values,
                    log_pc.values, log_pe.values, log_pt.values,
                    #log_qc.values,
                ...
                [
                    #rnn_grads.values,
                    log_py_Ea_grads.values,
                    log_pc_grads.values, log_pe_grads.values, log_pt_grads.values,
                    #log_qc_grads.values,
