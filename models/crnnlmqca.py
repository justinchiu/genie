    ...
    def forward(
        ...
        for t, (
            ...
            if K > 0:
                ...
                e_s_t, e_s_log_qe_t = self.sample_a(qe_t, log_qe_t, self.K, "e", "k")
                t_s_t, t_s_log_qt_t = self.sample_a(qt_t, log_qt_t, self.K, "t", "k")
                e_s_log_pe_t = log_pe_t.gather("e", e_s_t, "k")
                t_s_log_pt_t = log_pt_t.gather("t", t_s_t, "k")
                # linearize
                idxs = e_s_t * T_size + t_s_t
                # sampled and flatten values at timestep t
                v_f_t = v2dx_t.stack(("e", "t"), "r").gather("r", idxs, "k")
                v_f_log_qv_t = e_s_log_qe_t + t_s_log_qt_t
                ...
                if self.qconly:
                    ...
                    Eqa_log_py_a_t = logaddexp(
                        ...
                        log_py_ac1_t
                            + e_s_log_pe_t + t_s_log_pt_t
                            - e_s_log_qe_t - t_s_log_qt_t + log_pc_t.get("copy", 1),
                    )
                    ...
                    Eqa_log_py_a_t = logaddexp(
                        ...
                        log_py_ac1_t
                            + e_s_log_pe_t + t_s_log_pt_t
                            - e_s_log_qe_t - t_s_log_qt_t + math.log(0.5),
                    )
                    nll_t = -Eqa_log_py_a_t.mean("k")[y_maskt].sum()
                    log_py_z = Eqa_log_py_a_t
                ...
                if learn:
                    Bt = log_py_Ea_t
                    rewardt = (log_py_z - Bt).detach() * v_f_log_qv_t
